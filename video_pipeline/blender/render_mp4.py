...
Usage (PowerShell):
  & $BlenderExe --background video_pipeline/blender/india_network_scene.blend --python video_pipeline/blender/render_mp4.py -- \
    --out main/static/main/videos/india_network_hero.mp4
...
def main():
    ...
    # Prefer a cleaner-looking output for a hero/marketing video
    scene.render.ffmpeg.constant_rate_factor = "LOW"  # better quality (larger file) than HIGH
